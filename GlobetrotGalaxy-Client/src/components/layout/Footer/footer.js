            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img class="w-auto h-auto" src="https://i.ibb.co/TMcmCGz/pngwing-com.png" alt="" />
                    ...
                    <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Vui lòng nhập email:</p>
                ...
                <p class="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by GlobetrotGalaxy</p>
            </div>
        </section>
